...
public class TriangleTest {
    ...
    public void getArea_pA_pB_xyTest() {
        ...
        final double actual = triangleTest.getArea_pA_pB_xy();
        assertEquals(expected, actual);
    }
    ...
    public void getArea_pA_xy_pCTest() {
        ...
        final double actual = triangleTest.getArea_pA_xy_pC();
        assertEquals(expected, actual);
    }
    ...
    public void getArea_xy_pB_pCTest() {
        ...
        final double actual = triangleTest.getArea_xy_pB_pC();
        assertEquals(expected, actual);
    }
    ...
    public void isInsideTrue() {
        ...
        final boolean actual = triangleTest.isInside();
        assertEquals(expected, actual);
    }
}
